...
<li><a href="transactions.php">Public Ledger</a></li>
     ...
     <!-- Jumbotron -->
       ...
       <h1>Witaj na stronie VIRTCOIN'a!</h1>
        <p class="lead">Nasze monety są hybrydą anonimowych kryptowalut. Są do zdobycia głównie dzięki metodzie drop i są ustawione tak, aby były w pełni zdecentralizowane dając jednostkom pełną kontrolę i anonimowość.</p>
