...
<script>
  ...
  ga('send', 'pageview');
    ...
    <!-- Jumbotron -->
      <div class="jumbotron">    
        <h1>valuecoin(VAC)</h1>
        <p class="lead"><strong>Date Created:</strong> 2016-09-17 14:47:18</p>
        <p class="lead"><strong>Max Circulation:</strong> 10000000000 coins</p>
        ...
        TRANSACTION DATE | TRANSACTION TYPE | MD5 HASH OF SIGNATURE<br />
              09-17-2016 144743 | new wallet | <font color="#00C50A">1cffd97ff942337efc366f113d9c2a8b</font> <br />  
